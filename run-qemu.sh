...
# bindgen ../seL4/libsel4/loader_include/kernel_bootinfo.h --no-layout-tests --blocklist-item 'seL4_CPtr' -- -Ibuild/qemu_virt_aarch64_multikernel/debug/sel4/install/libsel4/include > tool/microkit/src/kernel_bootinfo.rs
